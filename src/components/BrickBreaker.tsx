...
const BrickBreaker: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center gap-6 p-4 min-h-screen bg-background">
      ...
      {/* Game Canvas */}
      <div className="p-4 bg-card border-primary">
        <canvas
          ref={canvasRef}
          width={CANVAS_WIDTH}
      ...
      <div className="flex gap-4 flex-wrap justify-center">
        <button 
          onClick={startGame}
          disabled={gameState.gameStatus === 'GAME_OVER' || gameState.gameStatus === 'WIN'}
        >
      ...
      <div className="p-4 max-w-2xl text-center">
        ...
        <div className="text-sm text-muted-foreground space-y-1">
          ...
          <p><strong>Keyboard:</strong> Arrow keys or A/D to move paddle</p>
          <p><strong>Launch:</strong> SPACE or ENTER to launch ball</p>
          <p><strong>Pause:</strong> P key to pause/resume</p>
          <p><strong>Mobile:</strong> Touch and drag to control paddle</p>
        </div>
      </div>
    </div>
  );
